...
public class VersionResource extends JsonResource {
    ...
    public String getVersionServer(String type, String privilege) throws MalformedURLException {
        ...
        hashMap.put(UrlPattern.PRIVILEGE_KEY, privilege);
        if (privilege.equals(String.valueOf(UrlPattern.PRIVILEGE_PARENT))){
